...
async def get_custom_notifications(request: Request, group_id: int = None, user_id: int = None):
    data_page = {"request": request, "access": False, "title_h1": "Настраиваемые уведомления"}
